...
#
# Generated by export_simulation on Fri Mar 16 15:40:26 -0400 2018
#
################################################################################
...
switch to the './runner_rom.sh' script.

./runner_rom.sh -reset_run
...
./runner_rom.sh -noclean_files

For more information on the script, please type './runner_rom.sh -help'.
